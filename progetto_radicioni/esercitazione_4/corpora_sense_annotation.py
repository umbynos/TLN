...
# - 1: diversi -> le due parole sono diverse, ma poterbbero avere piccoli dettagli che le accuminino; potrebbero essere trovato in un articolo ch tochi il loro argomento (es: software e tastiera)
# - 0: completamente diversi -> le due parole non hanno lo stesso significato e appartengono a tpic diversi (es: biro e rana)
...
# Calcolare la similarità coe il massimo ottenuto (come per es 1) utilizzando come metrica la cosine-similarity fra i vettori NASARI dei sensi associati ai vari termini
